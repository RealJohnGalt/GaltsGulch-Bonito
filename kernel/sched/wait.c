...
int __sched autoremove_wake_function(wait_queue_entry_t *wait, unsigned mode, int sync, void *key)
{
 ...
 *
 */
long __sched wait_woken(wait_queue_entry_t *wait, unsigned mode, long timeout)
{
...
int __sched woken_wake_function(wait_queue_entry_t *wait, unsigned mode, int sync, void *key)
{
	/*
...
int __sched wake_bit_function(wait_queue_entry_t *wait, unsigned mode, int sync, void *arg)
{
